...
export function MobileNav({ items }: { items: NavItem[] }) {
  ...
  // O drawer é renderizado via portal no <body> para escapar de qualquer
  // contexto de empilhamento/containing-block do header (ex.: backdrop-filter),
  // que prenderia o position:fixed dentro do header.
  const drawer = (
    <div
    ...
    >
      <div
        className="absolute inset-0 bg-green-900/60 backdrop-blur-sm"
